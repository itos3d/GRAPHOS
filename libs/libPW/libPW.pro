...
LIBPW_OPTIONS += with_opencv

DEFINES += LIBPW_LIBRARY
contains(LIBPW_OPTIONS, with_opencv){
    DEFINES += WITH_OPENCV
}
...
#    Tools/OrtoSkyXMLDefinitions.h
    ...
    MSD/MSDMatching.h \
    MSD/MSDProcess.h \
    Preprocessing/cvDecolorProcess.h \
    SURE/MergeLasResultsProcess.h \
    ASIFT_UNIBO/ASIFTUProcess.h \
    ASIFT_UNIBO/ASIFTUkpd.h \
    ASIFT_UNIBO/ASIFTUmatching.h \
    SURE/CustomSureProcess.h \
    MicMac/MicMacDenseProcessObjectSpace.h \
    MicMac/MicMacMultiMainImage.h \
    ASIFT_UNIBO/asiftdetector.h \
    MicMac/PlyMergeProcess.h \
    MicMac/MicMacComputeSlavesProcess.h \
    MicMac/C3DCProcess.h \
    BatchAuxProcess/TapiocaFinishedProcess.h \
    BatchAuxProcess/MSDFinishedProcess.h \
    BatchAuxProcess/ASIFTFinishedProcess.h \
    BatchAuxProcess/AperoFinishedProcess.h \
    GeorefMicMac/GCP.h \
    GeorefMicMac/imgPoint.h \
    GeorefMicMac/imgPointWriter.h \
    GeorefMicMac/GCPWriter.h \
    GeorefMicMac/GCPBasculeProcess.h \
    Tools/ScaleProcess.h \
    Tools/Video2ImagesProcess.h \
    GeorefMicMac/CampariProcess.h

contains(LIBPW_OPTIONS, with_opencv){
    HEADERS +=  OpenCV/OpenCV_kpm_process.h \
                OpenCV/OpenCVKpM.h \
...
SOURCES += tests/TestAperoDistReader.cpp \
    ...
    MSD/MSDMatching.cpp \
    MSD/MSDProcess.cpp \
    Preprocessing/cvDecolorProcess.cpp \
    SURE/MergeLasResultsProcess.cpp \
    ASIFT_UNIBO/ASIFTUProcess.cpp \
    ASIFT_UNIBO/ASIFTUkpd.cpp \
    ASIFT_UNIBO/ASIFTUmatching.cpp \
    SURE/CustomSureProcess.cpp \
    MicMac/MicMacDenseProcessObjectSpace.cpp \
    MicMac/MicMacMultiMainImage.cpp \
    ASIFT_UNIBO/asiftdetector.cpp \
    MicMac/PlyMergeProcess.cpp \
    MicMac/MicMacComputeSlavesProcess.cpp \
    MicMac/C3DCProcess.cpp \
    BatchAuxProcess/TapiocaFinishedProcess.cpp \
    BatchAuxProcess/MSDFinishedProcess.cpp \
    BatchAuxProcess/ASIFTFinishedProcess.cpp \
    BatchAuxProcess/AperoFinishedProcess.cpp \
    GeorefMicMac/GCP.cpp \
    GeorefMicMac/imgPoint.cpp \
    GeorefMicMac/imgPointWriter.cpp \
    GeorefMicMac/GCPWriter.cpp \
    GeorefMicMac/GCPBasculeProcess.cpp \
    Tools/ScaleProcess.cpp \
    Tools/Video2ImagesProcess.cpp \
    GeorefMicMac/CampariProcess.cpp

contains(LIBPW_OPTIONS, with_opencv){
    SOURCES +=  OpenCV/OpenCV_kpm_process.cpp \
...
debug{
    win32-*{
        ...
        !contains(QMAKE_TARGET.arch, x86_64) {
            ...
            $$PWD/../../libs/libOrsaAsift/build64/debug/orsaAsift.lib
            contains(LIBPW_OPTIONS, with_opencv){
    ...
    win32-*{
        !contains(QMAKE_TARGET.arch, x86_64) {
            ...
            $$PWD/../../libs/libOrsaAsift/build64/release/orsaAsift.lib
            contains(LIBPW_OPTIONS, with_opencv){
                LIBS += -L$$PWD/../../libs/vlfeat-0.9.20/bin/win64
                LIBS += -L$$PWD/../../libs/openCV3_1_vs10_x64_2/x64/vc10/lib \
                        -L$$PWD/../../libs/boost_1_58_0_msvc10_64/lib64-msvc-10.0 \
