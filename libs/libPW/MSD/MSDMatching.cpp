...
//                 {
//                     if (tiePointsLeft[matches[i].queryIdx].pt.x<=mOriginalImageWidth && tiePointsLeft[matches[i].queryIdx].pt.x>=0 &&
//                             tiePointsRight[matches[i].trainIdx].pt.x<=mOriginalImageWidth && tiePointsRight[matches[i].trainIdx].pt.x>=0 &&
//                             tiePointsLeft[matches[i].queryIdx].pt.y<=mOriginalImageHeight && tiePointsLeft[matches[i].queryIdx].pt.y>=0 &&
//                             tiePointsRight[matches[i].trainIdx].pt.y<=mOriginalImageHeight && tiePointsRight[matches[i].trainIdx].pt.y>=0)
//                     {
...
//            if (i<j) {
            ...
            if(i!=j){
                ...
                QString homolPath=matchesFolder+"/Matches/MSD/Pastis"+QFileInfo(mImagesPathList.at(i)).fileName();
                ...
                if (!mMatchingsMap.contains(matchingsKey)) {
                    ...
                    homolPath=matchesFolder+"/Matches/MSD/Pastis"+QFileInfo(mImagesPathList.at(i)).fileName();
...
float MSDMatching::round(float f,int precission)
{
